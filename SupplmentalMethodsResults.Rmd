...
The prior used for each variance parameter  $v\in\{\sigma^2, \sigma^2_\text{cohort}, \sigma^2_\text{G}, \sigma^2_\text{GxD}\}$ was an inverse gamma with shape=-1 and rate=0. Standard additive, polygenic heritability was defined as the fraction
$$
...
kab.summary(lookup="g", string="additive genetics (G)")
